 ...
 *
 * @author     Fiuze Magento Team <magento@Fiuze.com>
 * @category   Fiuze
 * @package    Magento Shell Tools
 * @copyright  Copyright (c) 2014 Fiuze Inc. (http://www.fiuze.com)
...
/**
 * Class Fiuze_Shell_Magentodump
 *
 * Used to back up a Magento MySQL database from the command line
 */
class Fiuze_Shell_Magentodump extends Mage_Shell_Abstract
{
...
$shell = new Fiuze_Shell_Magentodump();
$shell->run();
