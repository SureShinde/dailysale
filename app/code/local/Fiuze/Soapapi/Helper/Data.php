 ...
 * @author Mihail
 */
class Fiuze_Soapapi_Helper_Data extends Mage_Core_Helper_Data
{
    /**
     * soap client
     *
     * @var string
     */
    const SOAP_CLIENT            = 'soapapi/view/soapclient';
     ...
     * @var string
     */
    const API_USER     = 'soapapi/view/apiuser';
     ...
     * @var string
     */
    const API_KEY    = 'soapapi/view/apikey';
