...
class TM_NewsletterBooster_Adminhtml_Newsletterbooster_GatewayController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _initAction() {
        ...
        $this->_setActiveMenu('templates_master/newsletterbooster/gateway')
            ->_addBreadcrumb(
                Mage::helper('newsletterbooster')->__('Gateway Manager'),
                Mage::helper('newsletterbooster')->__('Gateway')
            );
        $this->_addContent(
            $this->getLayout()->createBlock('newsletterbooster/adminhtml_gateway')
        );
        return $this;
    }
