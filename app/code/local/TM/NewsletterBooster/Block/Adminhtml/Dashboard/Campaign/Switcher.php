...
class TM_NewsletterBooster_Block_Adminhtml_Dashboard_Campaign_Switcher extends Mage_Adminhtml_Block_Template
{
/**
    ...
    public function getCampaigns()
    {
        ...
        if ($store = $this->getRequest()->getParam('store')) {
            $campaigns = $model->getOptionArray($store);
        } else {
            $campaigns = $model->getOptionArray();
        }
    ...
    {
        return $this->getRequest()->getParam('campaign');
    }
    
    public function getSwitchCampaignUrl($flag)
    {
        if ($flag) {
            return $this->getUrl('*/*/*', array('_current' => true));
        } else {
            if ($store = $this->getRequest()->getParam('store')) {
                return $this->getUrl('*/*/*', array('store' => $store));
            }
        }
