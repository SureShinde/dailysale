...
class TM_NewsletterBooster_Block_Adminhtml_Subscriber_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('newsletterbooster_subscribers_grid');
    ...
    {
        return $this->getUrl('*/newsletterbooster_view/index', array('id' => $row->getCampaignId()));
    }
}